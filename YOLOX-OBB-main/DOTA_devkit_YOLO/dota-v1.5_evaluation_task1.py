...
def voc_eval(detpath,
    ...
    imagenames = [x.strip() for x in imagenames if x.strip() != '']
...
def main():
    ...
    detpath = 'E:/YGF/Yolox/YOLOX-OBB-main/YOLOX-OBB-main/result_output/detpath/UFL-YOLOX4.25/{:s}.txt'

    annopath = 'E:/YGF/Yolox/YOLOX-OBB-main/YOLOX-OBB-main/result_output/annopath/labelTxt/{:s}.txt'
    # annopath = 'E:/YGF/Yolox/YOLOX-OBB-main/YOLOX-OBB-main/result_output/val/labelTxt-v1.0/labelTxt/{:s}.txt'
