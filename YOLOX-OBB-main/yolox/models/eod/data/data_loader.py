...
from yolox.models.eod.utils.general.registry_factory import DATALOADER_REGISTRY, BATCHING_REGISTRY
...
class BaseDataLoader(DataLoader):
    def __init__(self,
        ...
        worker_init_fn = None
        if worker_init:
            from yolox.models.eod.utils.env.gene_env import worker_init_reset_seed
