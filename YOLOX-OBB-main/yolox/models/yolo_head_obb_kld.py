...
class YOLOXHeadOBB_KLD(nn.Module):
    def __init__(
        ...
        # self.varifocal2 = VarifocalLoss(reduction='none')   #加入VariFocalLoss初始化
        # self.EFL = QualityFocalLoss()
        # self.EFL = EqualizedFocalLoss(reduction='none')
        ...
        # self.iou_loss = balanced_equalized_focal_loss()
